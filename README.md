...
Rust API, so it's easy to jump between the two. Please find an example mock definition file in the `httpmock` 
Github repository [here](https://github.com/alexliesenfeld/httpmock/blob/master/tests/resources/static_yaml_mock.yaml). 
