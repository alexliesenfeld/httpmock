...
#[deprecated(
    since = "0.5.0",
    note = "Please use new API instead (see https://github.com/alexliesenfeld/httpmock/blob/master/CHANGELOG.md#version-050)"
)]
pub struct Mock {
    mock: MockDefinition,
}
...
impl Mock {
    ...
    #[deprecated(
        since = "0.5.0",
        note = "Please use the new API instead (see https://github.com/alexliesenfeld/httpmock/blob/master/CHANGELOG.md#version-050)"
    )]
